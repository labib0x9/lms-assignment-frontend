                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Link
                        href={`/courses/${docId}`}
                        className="flex-1 py-2.5 px-3 text-xs font-semibold text-[#0a192f] bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors text-center"
                      >
                        View Curriculum
                      </Link>
                      <button
                        onClick={handleEnrollClick}
                        className="flex-1 py-2.5 px-3 text-xs font-semibold text-white bg-[#0a192f] hover:bg-[#132c52] rounded-xl shadow-xs transition-colors text-center"
                      >
